    ...
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "64px 24px" }} className="fade-in">
      <div className="hero-section" style={{ padding: "40px 0 48px", textAlign: "left" }}>
        ...
        <p style={{ fontSize: "15px", color: "var(--text-secondary)", maxWidth: "560px", lineHeight: 1.7 }}>
          Last updated: July 2026. These Terms &amp; Conditions govern your use of the SOPMaster platform.
        </p>
      </div>

      <div className="glass" style={{ padding: "32px", marginBottom: "24px" }}>
        <p style={{ fontSize: "14px", color: "var(--slate-300)", lineHeight: 1.7 }}>
          These Terms &amp; Conditions (&ldquo;Terms&rdquo;) govern your access to and use of the SOPMaster platform, website and associated services (collectively, the &ldquo;Platform&rdquo;). By registering for or using the Platform, you agree to be bound by these Terms. If you do not agree, you must not use the Platform.
        </p>
      </div>
      ...
      <div className="glass" style={{ padding: "32px", marginBottom: "24px" }}>
        ...
        <p style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.6 }}>
          2.4 You must notify us immediately of any unauthorised use of your account by contacting <a href="mailto:Support@sopmaster.tech" style={{ color: "var(--accent)", textDecoration: "none" }}>Support@sopmaster.tech</a>.
        </p>
      </div>
      ...
      <div className="glass" style={{ padding: "32px", marginBottom: "24px" }}>
        ...
        <p style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.6 }}>
          4.4 We reserve the right to change subscription pricing with 30 days&rsquo; notice. Price changes will not affect your current billing period.
        </p>
      </div>
      ...
      <div className="glass" style={{ padding: "32px", marginBottom: "24px" }}>
        ...
        <p style={{ fontSize: "14px", color: "var(--slate-300)", lineHeight: 1.7, marginBottom: "12px" }}>
          6.3 If you believe you have been charged in error, contact <a href="mailto:Support@sopmaster.tech" style={{ color: "var(--accent)", textDecoration: "none" }}>Support@sopmaster.tech</a> within 14 days of the charge. We will investigate and, where appropriate, issue a refund.
        </p>
        <p style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.6 }}>
      ...
      <div className="glass" style={{ padding: "32px", marginBottom: "24px" }}>
        ...
        <p style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.6 }}>
          10.4 The Platform is provided &ldquo;as is&rdquo; without any warranty, express or implied, including but not limited to warranties of merchantability, fitness for a particular purpose or non-infringement.
        </p>
      </div>
