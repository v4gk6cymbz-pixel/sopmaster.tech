    ...
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "64px 24px" }} className="fade-in">
      ...
      <div className="glass" style={{ padding: "32px", marginBottom: "24px" }}>
        <p style={{ fontSize: "14px", color: "var(--slate-300)", lineHeight: 1.7 }}>
          SOPMaster Limited (&ldquo;SOPMaster&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;) is committed to protecting your privacy. This policy explains how we collect, use, store and protect your personal information when you use our platform at sopmaster.tech and associated services.
        </p>
      </div>
      ...
      <div className="glass" style={{ padding: "32px", marginBottom: "24px" }}>
        ...
        <div style={{ display: "grid", gap: "16px" }}>
          ...
          <div>
            <h3 style={{ fontSize: "14px", fontWeight: 600, color: "var(--white)", marginBottom: "4px" }}>Company Information</h3>
            <p style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.6 }}>
          ...
          <div>
            <h3 style={{ fontSize: "14px", fontWeight: 600, color: "var(--white)", marginBottom: "4px" }}>Usage Data</h3>
            <p style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.6 }}>
      ...
      <div className="glass" style={{ padding: "32px", marginBottom: "24px" }}>
        ...
        <p style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.6 }}>
          Stripe&rsquo;s privacy policy is available at <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent)", textDecoration: "none" }}>stripe.com/privacy</a>.
        </p>
      </div>
      ...
      <div className="glass" style={{ padding: "32px", marginBottom: "24px" }}>
        ...
        <div style={{ display: "grid", gap: "8px", marginBottom: "16px" }}>
          <div style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.5 }}>
            <span style={{ color: "var(--white)", fontWeight: 500 }}>Right to access</span> &mdash; Request a copy of the personal data we hold about you.
          </div>
          <div style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.5 }}>
            <span style={{ color: "var(--white)", fontWeight: 500 }}>Right to rectification</span> &mdash; Request correction of inaccurate or incomplete data.
          </div>
          <div style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.5 }}>
            <span style={{ color: "var(--white)", fontWeight: 500 }}>Right to erasure</span> &mdash; Request deletion of your personal data where applicable.
          </div>
          <div style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.5 }}>
            <span style={{ color: "var(--white)", fontWeight: 500 }}>Right to restriction</span> &mdash; Request restriction of processing under certain circumstances.
          </div>
          <div style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.5 }}>
            <span style={{ color: "var(--white)", fontWeight: 500 }}>Right to portability</span> &mdash; Request transfer of your data to another service provider.
          </div>
          <div style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.5 }}>
            <span style={{ color: "var(--white)", fontWeight: 500 }}>Right to object</span> &mdash; Object to the processing of your personal data for legitimate interests.
          </div>
        </div>
        <p style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.6 }}>
          To exercise any of these rights, contact us at <a href="mailto:Support@sopmaster.tech" style={{ color: "var(--accent)", textDecoration: "none" }}>Support@sopmaster.tech</a>. We will respond to your request within 30 days.
        </p>
      </div>
      ...
      <div className="glass" style={{ padding: "32px", marginBottom: "24px" }}>
        ...
        <p style={{ fontSize: "13px", color: "var(--text-secondary)", lineHeight: 1.6 }}>
          Email: <a href="mailto:Support@sopmaster.tech" style={{ color: "var(--accent)", textDecoration: "none" }}>Support@sopmaster.tech</a>
        </p>
      </div>
