...
export default function AboutPage() {
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "64px 24px" }} className="fade-in">
      ...
      <div className="card" style={{ padding: "32px", marginBottom: "24px" }}>
        <div className="card-header" style={{ fontSize: "13px", marginBottom: "20px" }}>Built for Consultants, by Consultants</div>
        <p style={{ fontSize: "14px", color: "#CBD5E1", lineHeight: 1.7, marginBottom: "16px" }}>
      ...
      <div className="card" style={{ padding: "32px", marginBottom: "24px" }}>
        <div className="card-header" style={{ fontSize: "13px", marginBottom: "20px" }}>What We Offer</div>
        <div style={{ display: "grid", gap: "20px" }}>
          <div>
            <h3 style={{ fontSize: "14px", fontWeight: 600, color: "#F1F5F9", marginBottom: "6px" }}>Standard Operating Procedures</h3>
          ...
          <div>
            <h3 style={{ fontSize: "14px", fontWeight: 600, color: "#F1F5F9", marginBottom: "6px" }}>Operational Checklists</h3>
            <p style={{ fontSize: "13px", color: "#94A3B8", lineHeight: 1.6 }}>
          ...
          <div>
            <h3 style={{ fontSize: "14px", fontWeight: 600, color: "#F1F5F9", marginBottom: "6px" }}>Batch Documentation Packages</h3>
            <p style={{ fontSize: "13px", color: "#94A3B8", lineHeight: 1.6 }}>
          ...
          <div>
            <h3 style={{ fontSize: "14px", fontWeight: 600, color: "#F1F5F9", marginBottom: "6px" }}>Document Vault</h3>
            <p style={{ fontSize: "13px", color: "#94A3B8", lineHeight: 1.6 }}>
      ...
      <div className="card" style={{ padding: "32px", marginBottom: "24px" }}>
        <div className="card-header" style={{ fontSize: "13px", marginBottom: "20px" }}>Why Operational Documentation Matters</div>
        <p style={{ fontSize: "14px", color: "#CBD5E1", lineHeight: 1.7, marginBottom: "16px" }}>
      ...
      <div className="card" style={{ padding: "32px" }}>
        <div className="card-header" style={{ fontSize: "13px", marginBottom: "20px" }}>Our Commitment</div>
        <p style={{ fontSize: "14px", color: "#CBD5E1", lineHeight: 1.7, marginBottom: "16px" }}>
        ...
        <p style={{ fontSize: "14px", color: "#64748B", lineHeight: 1.7 }}>
          For support or enquiries, contact us at <a href="mailto:Support@sopmaster.tech" style={{ color: "#3B82F6", textDecoration: "none" }}>Support@sopmaster.tech</a>.
        </p>
      </div>
    </div>
  );
